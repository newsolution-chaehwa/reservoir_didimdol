<template>
  <div style="
    ...
    <div style="display: flex">
      ...
      <div style="display: flex; margin: 0 0 0 350px">
        <total-dashboard :total-count="totalCount" :below-80-count="below80Count" :below-50-count="below50Count"
          :below-30-count="below30Count" :over-80-count="over80Count" :is-all-null="isAllNull"></total-dashboard>
        <rates-container index="1" title="80%이하" :collapse-class="collapseClass80" :collapse="collapse80"
          v-on:close-tab="closeTab" point-color="#F0981C" v-on:show-more="showMore" :reservoir-list="below80Count"
          v-on:set-map-center="setMapCenter" v-on:open-reservoir-detail="openReservoirDetail"></rates-container>
        <rates-container index="2" title="50%이하" :collapse-class="collapseClass50" :collapse="collapse50"
          v-on:close-tab="closeTab" point-color="#E6EB03" v-on:show-more="showMore" :reservoir-list="below50Count"
          v-on:set-map-center="setMapCenter" v-on:open-reservoir-detail="openReservoirDetail"></rates-container>
        <rates-container index="3" title="30%이하" :collapse-class="collapseClass30" :collapse="collapse30"
          v-on:close-tab="closeTab" v-on:show-more="showMore" point-color="#E6EB03" :reservoir-list="below30Count"
          v-on:set-map-center="setMapCenter" v-on:open-reservoir-detail="openReservoirDetail"></rates-container>
      </div>
  ...
  <div style="width: calc(100vw - 90px)">
    <el-dialog center align-center draggable v-model="showDialog" style="
        z-index: 9000;
        width: 750px;
        /* height: 530px; */
        height: 500px;
        ...
        border-radius: 8px;
      " :show-close="true" @close="closeReservoirInfo(reservoirInfo)">
      <template #header>
        <div style="
            margin: 0;
            padding: 0;
      ...
      <div style="display: flex; justify-content: space-between">
        ...
        <div style="width: 50%; font-family: 'NotoSansKR-Regular'; height: 100%">
          ...
          <div class="rate-container">
            ...
            <div>
              ...
              <div v-if="reservoirInfo.reservoirId === 4682010078">
                ...
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 신방 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010373">
                {{ yesterdayData.sinbang.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 동해 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010117">
                {{ yesterdayData.donghea.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 가학 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010160">
                {{ yesterdayData.gahack.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 연화 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010050">
                {{ yesterdayData.yeonhwa.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 해원 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010098">
                {{ yesterdayData.heawon.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 신덕 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010346">
                {{ yesterdayData.sinduck.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 화원 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010168">
                {{ yesterdayData.hwawon.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 구시 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010067">
                {{ yesterdayData.gusi.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <!-- 군곡 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010099">
                {{ yesterdayData.gungock.elm }}
                <span style="font-size: 13px"> el.m</span>
              </div>
              <div v-else style="font-size: 11px; display: flex; align-items: center">
                서비스 준비 중 입니다.
              </div>
            </div>
            <div>
              ...
              <div v-if="reservoirInfo.reservoirId === 4682010078">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.gusan.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010373">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.sinbang.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.sinbang.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010117">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.donghea.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.donghea.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010160">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.gahack.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.gahack.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010050">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.yeonhwa.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.yeonhwa.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010098">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.heawon.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.heawon.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010346">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.sinduck.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.sinduck.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010067">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.gusi.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.gusi.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010099">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.gungock.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.gungock.elmUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010168">
                <div style="
                  ...
                  ">
                  <div>
                    {{ yesterdayData.hwawon.elmUdValue }}
                    <span style="font-size: 12px">el.m</span>
                  </div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.heawon.elmUd === 1">
          ...
          <div class="rate-container" style="margin: 10px 0 0 0">
            ...
            <div>
              ...
              <!-- 신방 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010373">
                {{ yesterdayData.sinbang.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 동해 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010117">
                {{ yesterdayData.donghea.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 가학 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010160">
                {{ yesterdayData.gahack.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 연화 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010050">
                {{ yesterdayData.yeonhwa.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 해원 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010098">
                {{ yesterdayData.heawon.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 화원 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010168">
                {{ yesterdayData.hwawon.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 군곡 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010099">
                {{ yesterdayData.gungock.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 구시 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010067">
                {{ yesterdayData.gusi.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <!-- 신덕 -->
              <div v-else-if="reservoirInfo.reservoirId === 4682010346">
                {{ yesterdayData.sinduck.rate }}
                <span style="font-size: 13px">%</span>
              </div>
              <div v-else style="font-size: 11px; display: flex; align-items: center">
                서비스 준비 중 입니다.
            ...
            <div>
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010373">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.sinbang.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.sinbang.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010117">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.donghea.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.donghea.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010160">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.gahack.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.gahack.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010050">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.yeonhwa.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.yeonhwa.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010098">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.heawon.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.heawon.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010067">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.gusi.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.gusi.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010346">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.sinduck.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.sinduck.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010168">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.hwawon.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.hwawon.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
              ...
              <div v-else-if="reservoirInfo.reservoirId === 4682010099">
                <div style="
                    ...
                    justify-content: center;
                  ">
                  <div>{{ yesterdayData.gungock.rateUdValue }}%</div>
                  <div style="display: flex; align-items: center">
                    <el-icon v-if="yesterdayData.gungock.rateUd === 1">
                      <CaretTop />
                    </el-icon>
                    <el-icon v-else>
                      <CaretBottom />
          ...
          <div>
            <el-button @click="changeRoute('/predict')" color="#0d4ba9" class="rate-button">예측 저수율 보러 가기</el-button>
          </div>

          <div style="margin: 30px 0 0 0">
            <div class="reservoir-info-content-title" style="display: flex; justify-content: space-between">
              <div>기상 정보</div>
            ...
            <div class="rate-container" style="margin: 5px 0 0 0">
              <div>
                <div>강수량</div>
                <div>{{ weatherSet.rain }}</div>
              </div>
              <div>
                <div>평균온도</div>
                <div>{{ weatherSet.avgTemp }}</div>
              </div>
              <div>
                <div>최고기온</div>
                <div>{{ weatherSet.maxTemp }}</div>
              </div>
              <div>
                <div>풍속</div>
                <div>{{ weatherSet.wd }}</div>
              </div>
              <div>
                <div>습도</div>
                <div>{{ weatherSet.hm }}</div>
              </div>
            </div>
            <div></div>
          </div>
    ...
    <!-- warning dialog -->
    <el-dialog v-model="showSearchError" :show-close="true" center align-center style="width: 400px; border-radius: 8px"
      ...
      <template #footer>
        <div style="display: flex; justify-content: flex-end">
          <el-button color="#0d4ba9" @click="showSearchError = false">확인</el-button>
        </div>
      </template>
    </el-dialog>
...
// import yesterdayData from "/home/gpuadmin/Saeron/sungmin/server/model_result/yester_day_last_year_data.json";
// import yesterdayPolygon from "../../yesterday_polygon.json";
// import yesterdayPolygon from "/home/gpuadmin/Saeron/sungmin/server/model_result/map_data_dict_list.json";
import WeatherContainer from "./WeatherContainer.vue";
import BranchesContainer from './BranchesContainer.vue'
...
export default {
  ...
  methods: {
    ...
    initWeatherData(id) {
      ...
      this.$axios.get('http://192.168.0.73:3000/weather').then(response => {

        for (let i = 0; i < response.data.length; i++) {

          // console.log(reservoir)
          // if(response.)
          if (response.data[i].stn === id) {
            this.weatherSet.rain = response.data[i].day_rain
            this.weatherSet.avgTemp = response.data[i].hour_avg_temp
            this.weatherSet.maxTemp = response.data[i].hour_max_temp
            this.weatherSet.wd = response.data[i].hour_wd
            this.weatherSet.hm = response.data[i].hour_hm
          }
        }
      })
    ...
    initDataFromDB() {
      this.$axios
        .get("http://192.168.0.73:3000/yesterday/map")
        .then((response) => {

          this.yesterdayPolygon = response.data
    ...
    initYesterdayData() {
      ...
      this.$axios
        .get("http://192.168.0.73:3000/yesterday")
        .then((response) => {

          for (let i = 0; i < response.data.length; i++) {
            switch (response.data[i].reservoir_name) {
              case "gusan":
                this.yesterdayData.gusan.elm = response.data[i].elm;
                this.yesterdayData.gusan.rate = response.data[i].rate;
                this.yesterdayData.gusan.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.gusan.elmUd = response.data[i].elmUd;
                this.yesterdayData.gusan.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "sinbang":
                this.yesterdayData.sinbang.elm = response.data[i].elm;
                this.yesterdayData.sinbang.rate = response.data[i].rate;
                this.yesterdayData.sinbang.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.sinbang.elmUd = response.data[i].elmUd;
                this.yesterdayData.sinbang.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "donghea":
                this.yesterdayData.donghea.elm = response.data[i].elm;
                this.yesterdayData.donghea.rate = response.data[i].rate;
                this.yesterdayData.donghea.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.donghea.elmUd = response.data[i].elmUd;
                this.yesterdayData.donghea.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "gungock":
                this.yesterdayData.gungock.elm = response.data[i].elm;
                this.yesterdayData.gungock.rate = response.data[i].rate;
                this.yesterdayData.gungock.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.gungock.elmUd = response.data[i].elmUd;
                this.yesterdayData.gungock.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "gusi":
                this.yesterdayData.gusi.elm = response.data[i].elm;
                this.yesterdayData.gusi.rate = response.data[i].rate;
                this.yesterdayData.gusi.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.gusi.elmUd = response.data[i].elmUd;
                this.yesterdayData.gusi.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "heawon":
                this.yesterdayData.heawon.elm = response.data[i].elm;
                this.yesterdayData.heawon.rate = response.data[i].rate;
                this.yesterdayData.heawon.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.heawon.elmUd = response.data[i].elmUd;
                this.yesterdayData.heawon.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "sinduck":
                this.yesterdayData.sinduck.elm = response.data[i].elm;
                this.yesterdayData.sinduck.rate = response.data[i].rate;
                this.yesterdayData.sinduck.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.sinduck.elmUd = response.data[i].elmUd;
                this.yesterdayData.sinduck.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "yeonhwa":
                this.yesterdayData.yeonhwa.elm = response.data[i].elm;
                this.yesterdayData.yeonhwa.rate = response.data[i].rate;
                this.yesterdayData.yeonhwa.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.yeonhwa.elmUd = response.data[i].elmUd;
                this.yesterdayData.yeonhwa.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "gahack":
                this.yesterdayData.gahack.elm = response.data[i].elm;
                this.yesterdayData.gahack.rate = response.data[i].rate;
                this.yesterdayData.gahack.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.gahack.elmUd = response.data[i].elmUd;
                this.yesterdayData.gahack.elmUdValue =
                  response.data[i].elmUdValue;
                break;
              case "hwawon":
                this.yesterdayData.hwawon.elm = response.data[i].elm;
                this.yesterdayData.hwawon.rate = response.data[i].rate;
                this.yesterdayData.hwawon.rateUdValue =
                  response.data[i].rateUdValue;
                this.yesterdayData.hwawon.elmUd = response.data[i].elmUd;
                this.yesterdayData.hwawon.elmUdValue =
                  response.data[i].elmUdValue;
                break;
            }
          }
    ...
    initReservoirPolygon() {
      ...
      L.geoJson(this.reservoirPolygon, {
        style: (feature) => {
          console.log("feature", feature.properties.currentWaterRate);
      ...
      this.reservoirList.forEach((reservoir) => {
        ...
        new L.marker([reservoir.latlng[0], reservoir.latlng[1]], {
          ...
          .on("click", () => {
            ...
            this.initWeatherData(reservoir.observerId)
